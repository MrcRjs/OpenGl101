...
void displayFcn(void) {
    ...
    wcPt3D c01[4] = {{2.8,   0.7},
                     {3.05,  0},
                     {4.675, 0},
                     {5.3,   0.7}}; //BOCA
    wcPt3D c02[4] = {{5.3, 0.7},
                     {6,   1.35},
                     {6,   2.65},
                     {5.3, 3.3}};
    wcPt3D c03[4] = {{5.3,  3.3},
                     {4.55, 4.25},
                     {3.05, 4},
                     {2.3,  4}};
    wcPt3D c04[4] = {{2.3, 4},
                     ...
                     {0.8, 3},
                     {1.2, 2.2}};
    wcPt3D c05[4] = {{1.2, 2.2},
                     {0.9, 2.1},
                     {0.8, 1.4},
                     {1.3, 1.3}};
    wcPt3D c06[4] = {{1.3, 1.3},
                     {1.5, 1.27},
                     {1.9, 1.23},
                     {2.1, 1.2}};
    wcPt3D c07[4] = {{2.1, 1.2},
                     {1.8, 0.8},
                     {2.4, 0.4},
                     {2.8, 0.7}}; //BOCA

    wcPt3D c08[4] = {{1.62, 3.7},
                     {1.62, 4.2},
                     {1.65, 4.6},
                     {1.7,  5}};
    wcPt3D c09[4] = {{1.7, 5},
    ...
    wcPt3D c10[4] = {{1.4, 7},
                     ...
                     {1.2, 7.8},
                     {1.7, 7.8}};
    wcPt3D c11[4] = {{1.7,  7.8},
                     {2.3,  13},
                     {7.65, 13},
                     {7.9,  7.8}}; //CABEZA

    wcPt3D c12[4] = {{7.9,  7.8},
                     {7.7,  6.2},
                     {7.45, 5.5},
                     {7.3,  4.5}}; //OREJA
    wcPt3D c13[4] = {{6.9, 2.9},
                     {6.9, 2.2},
                     {7.0, 1.3},
                     {7,   0.6}};
    ...
    wcPt3D c14[4] = {{1.4, 7},
                     ...
                     {3.3, 7.6},
                     {3.5, 6.6}}; //OJOS
    wcPt3D c15[4] = {{4.7, 4.65},
                     {2.9, 4.5},
                     {2.9, 7.40},
                     {4.7, 7.25}};
    wcPt3D c16[4] = {{4.4, 4.65},
                     {6.2, 4.5},
                     {6.2, 7.40},
                     {4.4, 7.25}};
    wcPt3D c17[4] = {{2.7,  5.2},
                     {3.1,  5.2},
                     {3.3,  5.2},
                     {3.47, 5.35}}; //NARIZ
    wcPt3D c18[4] = {{2.7, 5.2},
                     {2,   5.2},
                     {2,   4},
                     {2.7, 4}};
    wcPt3D c19[4] = {{1.7,  5},
    ...
    wcPt3D c20[4] = {{6.9, 4.3},
                     {7.1, 4.55},
                     {7.5, 4.55},
                     {7.7, 4.3}}; //OREJA
    wcPt3D c21[4] = {{6.7, 3.1},
                     {6.8, 2.8},
                     {7.2, 2.8},
                     {7.3, 2.9}};
    wcPt3D c22[4] = {{7.7, 4.3},
                     {8,   3.9},
                     {7.7, 3},
                     {7.3, 2.9}};
    wcPt3D c23[4] = {{6.9,  3.4},
                     {6.9,  3.8},
                     {7.25, 4.2},
                     {7.4,  3.9}}; //OREJA

    wcPt3D c24[4] = {{4.3, 11.6},
                     {4.8, 12.5},
                     {6.4, 13},
                     {6.3, 10.5}}; //PELO
    wcPt3D c25[4] = {{5.3, 11.7},
                     {5.8, 12.5},
                     {7.5, 13},
                     {7.1, 10}};   //ARRIBA

    wcPt3D c26[4] = {{6.4,  4.3},
                     {7.2,  7},
                     {7.2,  7},
                     {7.35, 4.65}};    //PELO
    wcPt3D c27[4] = {{7.35, 4.65},
                     {8.1,  6.8},
                     {8.1,  6.8},
                     {8,    4.85}}; //COSTADO
