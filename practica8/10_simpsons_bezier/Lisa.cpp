...
void displayFcn(void)
{
	...
	wcPt3D c15[4] = {{4.7, 5.5}, {3.4, 5.35}, {3.4, 8.15}, {4.7, 8.0}}; //Ojo Completo
	wcPt3D c16[4] = {{4.6, 5.5}, {6.1, 5.35}, {6.1, 8.15}, {4.7, 8.0}};

	wcPt3D c17[4] = {{5.5, 5.9}, {6.0, 5.9}, {6.5, 5.8}, {6.5, 5.5}}; //Nariz
	wcPt3D c18[4] = {{5.4, 5.0}, {6.0, 4.8}, {6.5, 4.9}, {6.5, 5.5}}; //Nariz

	wcPt3D c19[4] = {{5.7, 7.2}, {6.0, 8}, {7.3, 8}, {7.5, 6.9}};   //ojo derecho
	wcPt3D c20[4] = {{6.5, 5.5}, {7, 5.5}, {7.6, 5.8}, {7.5, 6.9}}; //ojo derecho

	wcPt3D c29[4] = {{6.9, 5.55}, {6.9, 5.55}, {7.5, 4.8}, {7.5, 4.8}}; //Boca
	wcPt3D c30[4] = {{3.7, 4.3}, {5, 3.5}, {7, 3.65}, {7.5, 4.83}};		//
	wcPt3D c32[4] = {{3.6, 4.1}, {3.6, 4.1}, {3.8, 4.5}, {3.8, 4.5}};   //

	wcPt3D c31[4] = {{3.3, 4.4}, {2.4, 3.95}, {2.4, 5.65}, {3.3, 5.2}}; //Oreja
	wcPt3D c28[4] = {{2.9, 4.6}, {2.6, 4.8}, {2.9, 5.1}, {3.1, 4.9}};   //Oreja

	wcPt3D c33[4] = {{3.0, 4.3}, {3.1, 3.7}, {3.05, 3.5}, {3.0, 3.}};   //Cuello
	wcPt3D c34[4] = {{2.4, 4.3}, {2.4, 4.3}, {2.4, 3.6}, {2.4, 3.6}};   //Cabello
	wcPt3D c35[4] = {{2.4, 3.6}, {2.4, 3.6}, {3.05, 3.6}, {3.05, 3.6}}; //Cabello
	wcPt3D c36[4] = {{5.7, 3.8}, {5.5, 3.5}, {5.2, 3.6}, {5.2, 3.4}};   //Menton
	...
	wcPt3D c25[4] = {{2, 8}, {1.8, 9.5}, {1.3, 9.5}, {3, 9.8}};		  //ARRIBA
	wcPt3D c24[4] = {{3, 9.8}, {4, 11.5}, {3.5, 11.5}, {4.8, 10.5}};  //PELO
	wcPt3D c23[4] = {{4.8, 10.5}, {6, 11.5}, {5.5, 11.5}, {6.6, 10}}; //OREJA
	wcPt3D c22[4] = {{6.6, 10}, {8, 9.8}, {7.5, 9.8}, {7.5, 8.5}};
	wcPt3D c21[4] = {{7.5, 8.5}, {8.3, 7.8}, {8.3, 7.8}, {7.5, 6.9}};
