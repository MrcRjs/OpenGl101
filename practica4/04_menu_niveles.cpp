...
// Funciones de control del men� seleccionado, se ejecutan cuando el usuario utilice el men�
void menu_nivel2(int identificador1)
{
    /// Seg�n la opci�n del 2do nivel activada, ejecutar� una rutina u otra
...
{
    /// Seg�n la opcion de 1er nivel activada, se ejecutar� una rutina u otra
